        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[600px]">
          ...
          <div className="text-center lg:text-left space-y-8 fade-in">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold font-poppins text-[#dfeef1] leading-[1.1] tracking-tight" data-testid="hero-title">
              Transform Your
              <ContainerTextFlip text="Digital Future" className="block text-[#4680c6] animate-pulse"/>
            </h1>
          ...
          <div className="hidden lg:block fade-in">
            <div className="relative">
              ...
              <div className="bg-[#dfeef1]/95 backdrop-blur-xl rounded-3xl border border-[#dfeef1]/20 shadow-2xl p-2 relative overflow-hidden" data-testid="hero-illustration">
                {/* Glassmorphism Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#dfeef1]/10 to-[#dfeef1]/5 rounded-3xl"></div>
